...
import {AccordionFormItemTitle} from '@sbbol/web-library/desktop/components/AccordionForm/AccordionFormItemTitle';
import {AccordionFormItemContent} from '@sbbol/web-library/desktop/components/AccordionForm/AccordionFormItemContent';
import {AccordionFormItemFooter} from '@sbbol/web-library/desktop/components/AccordionForm/AccordionFormItemFooter';
...
import {ExpandAnimation} from '@sbbol/web-library/common/components/ExpandAnimation/ExpandAnimation';
                ...
                <h5 className={classnames({'cssClass[headerFocused]': headerFocused})}>
                    ...
                    {!disabled && onRemove && (
                        <div className="cssClass[remove]">
                            <ButtonIcon onClick={this.handleRemoveClick}>
