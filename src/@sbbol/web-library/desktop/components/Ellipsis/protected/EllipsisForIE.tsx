...
export class EllipsisForIE extends React.Component<IProps> {
    ...
    componentDidUpdate(prevProps: IProps): void {
        ...
        if (maxLine !== prevProps.maxLine || children !== prevProps.children) {
            this.truncate();
        }
    }

    /**
     * Метод, образающий текст.
     */
    truncate = (): void => {
    ...
    isOverflowing(domElement: HTMLDivElement): boolean {
        ...
        // Вычисляется максималльно доступная высота умножением количества строк на высоту строки.
