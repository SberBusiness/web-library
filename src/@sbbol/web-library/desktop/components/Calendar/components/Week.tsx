import {dateFormatYYYYMMDD, DAYS_SET, globalLimitRange} from '@sbbol/web-library/desktop/common/consts/DateConst';
import {IDateLimitRange} from '@sbbol/web-library/desktop/common/types/DateTypes';
import {TDayHtmlAttributes, TPickedRange} from '@sbbol/web-library/desktop/components/Calendar/types';
import {Day} from '@sbbol/web-library/desktop/components/Calendar/components/Day';
