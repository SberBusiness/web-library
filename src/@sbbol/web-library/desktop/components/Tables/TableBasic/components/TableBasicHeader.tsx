...
import {ECellType, EHorizontalAlign, EOrderDirection} from '@sbbol/web-library/desktop/components/Tables/TableBasic/enums';
import {ISortOrder, ITableBasicColumn} from '@sbbol/web-library/desktop/components/Tables/TableBasic/types';
import {mapHideScreenSizesToClassName, mapHorizontalAlignToClassName} from '@sbbol/web-library/desktop/components/Tables/utils';
...
import {isNullOrUndefined} from '@sbbol/web-library/desktop/utils/isNullOrUndefined';
...
export class TableBasicHeader extends React.PureComponent<ITableBasicHeaderProps> {
    ...
    private renderTh = (c: ITableBasicColumn, hasOrderFunc: boolean) => {
        ...
        const classNameTh = classnames(mapHorizontalAlignToClassName(c.horizontalAlign), mapHideScreenSizesToClassName(c.hideScreenSizes));
