...
import {StatusTrackerDeprecatedBody} from '@sbbol/web-library/desktop/components/StatusTrackerDeprecated/components/StatusTrackerDeprecatedBody';
import {StatusTrackerDeprecatedFooter} from '@sbbol/web-library/desktop/components/StatusTrackerDeprecated/components/StatusTrackerDeprecatedFooter';
import {StatusTrackerDeprecatedSteps} from '@sbbol/web-library/desktop/components/StatusTrackerDeprecated/components/StatusTrackerDeprecatedSteps';
import {
    StatusTrackerDeprecatedStatus,
    StatusTrackerDeprecatedStepNumber,
} from '@sbbol/web-library/desktop/components/StatusTrackerDeprecated/enums';
