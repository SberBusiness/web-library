import {StatusTrackerDeprecatedFooterText} from '@sbbol/web-library/desktop/components/StatusTrackerDeprecated/components/StatusTrackerDeprecatedFooterText';
